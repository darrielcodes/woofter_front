...
import ListMatches from '../MaterialUI/ListMatches';
import AccountList from "../MaterialUI/AccountList";
...
const urlEndpoint = 'http://localhost:3001/api'
...
function DashboardContent() {
  ...
  <ListItemButton onClick={() => setToggleAccount(false)}>
    <ListItemIcon>
      <MessageIcon />
    </ListItemIcon>
    <ListItemText primary="Messages" />
  </ListItemButton>
  <ListItemButton onClick={() => setToggleAccount(true)}>
    <ListItemIcon>
      <PeopleIcon />
    </ListItemIcon>
